...
-- -----------------------------------------------------
-- Table `supermercados_paranaiba`.`logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `supermercados_paranaiba`.`logs` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tabela_alterada` VARCHAR(40) NOT NULL,
  `tarefa_executada` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `supermercados_paranaiba`.`arquivos_ocorrencias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `supermercados_paranaiba`.`arquivos_ocorrencias` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `arquivo` TEXT NULL,
  `data_criacao` DATETIME NOT NULL,
  `ocorrencias_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_arquivos_ocorrencias_ocorrencias1_idx` (`ocorrencias_id` ASC),
  CONSTRAINT `fk_arquivos_ocorrencias_ocorrencias1`
    FOREIGN KEY (`ocorrencias_id`)
    REFERENCES `supermercados_paranaiba`.`ocorrencias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
