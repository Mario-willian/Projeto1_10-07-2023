// Recuperar do HTML o SELETOR cad-empresa-form com JavaScript
const cadempresaForm = document.getElementById("cad-empresa-form");

// Verificar se a constante cadempresaForm é TRUE
if (cadempresaForm) {

    // Aguardar e identificar o clique do usuário no botão cadstrar com JavaScript
    cadempresaForm.addEventListener("submit", async (e) => {

        // Bloquear o recarregamento da página com JavaScript
        e.preventDefault();

        // Receber os dados do formulário com JavaScript
        const dadosForm = new FormData(cadempresaForm);

        // Enviar os dados do JavaScript para o PHP
        const dados = await fetch("../classes/inserts/empresa.php", {
