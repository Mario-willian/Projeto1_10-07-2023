// Recuperar do HTML o SELETOR cad-recisao-form com JavaScript
const cadrecisaoForm = document.getElementById("cad-recisao-form");

// Verificar se a constante cadrecisaoForm é TRUE
if (cadrecisaoForm) {

    // Aguardar e identificar o clique do usuário no botão cadstrar com JavaScript
    cadrecisaoForm.addEventListener("submit", async (e) => {

        // Bloquear o recarregamento da página com JavaScript
        e.preventDefault();

        // Receber os dados do formulário com JavaScript
        const dadosForm = new FormData(cadrecisaoForm);

        // Enviar os dados do JavaScript para o PHP
        const dados = await fetch("../classes/inserts/recisao.php", {
